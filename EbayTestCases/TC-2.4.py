...
USERNAME = ""
test_case_id = "TC-2.4"
description = "Blank Username Login Attempt"
result = "FAIL"
screenshot_name = ""
...
try:
    ...
    if error_msg:
        print("TC-2.4: PASS")
        screenshot_name = "blank_username_detected.png"
        take_screenshot("blank_username_detected")
        result = "PASS"
    else:
        print("TC-2.4: FAIL - No error message shown")
        screenshot_name = "blank_username_not_detected.png"
        take_screenshot("blank_username_not_detected")

except Exception as e:
    print(f"TC-2.4: FAIL - {e}")
    screenshot_name = "blank_username_exception.png"
    take_screenshot("blank_username_exception")
